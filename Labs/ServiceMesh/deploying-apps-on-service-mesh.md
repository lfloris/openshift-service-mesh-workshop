...
To make sure the workloads add the new certificates promptly, delete the secrets generated by Service Mesh, named istio.*. In this example, istio-ca-secret. Service Mesh issues new certificates for the workloads.

```
$ oc -n bookinfo delete secret istio-ca-secret
